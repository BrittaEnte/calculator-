# wenn du deine file tkinter.py nennst, brauchst du einen strick oder eine pumpgun. 
from tkinter import *
...
#height gibt es nicht?
e = Entry(root, width = 35, borderwidth = 5)
e.grid(row =0, column = 0, columnspan = 3, padx = 10, pady = 10)

def button_click(number):
	current = e.get()
	e.delete(0,END) # ansonsten hast du nicht 23, sonder 232, weil current noch drin ist. 
	e.insert(0,str(current) + str(number))

def button_clear():
	e.delete(0, END) # delete old entry 
...
#define the buttons
#da du nicht button_click()machen kannst , nimmst du lambda
